...
{
    public partial class FormCargaSolicitadas : Form
    {
        public FormCargaSolicitadas()
        {
            InitializeComponent();
        }

        private void FormCargaSolicitadas_Load(object sender, EventArgs e)
        {
        ...
        {
            using (FormSolicitadasNuevo formulario = new FormSolicitadasNuevo())
            {
                // Aquí se abre el FormularioB
                if (formulario.ShowDialog() == DialogResult.OK)
                {
                    // Recién después de cerrar FormularioB, puedo leer el dato
                    txtIdRacionSolicitada.Text = formulario.IdRacionSolicitada;
                    txtConvenio.Text = formulario.Convenio;
                    dtpFechaSolicitada.Text = formulario.FechaSolicitada;
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            using (FormSolicitadasBuscar formulario = new FormSolicitadasBuscar())
            {
                // Aquí se abre el FormularioB
                if (formulario.ShowDialog() == DialogResult.OK)
                {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow fila in dtgSapMenus.Rows)
            {
                ...
                foreach (DataGridViewRow filaAux in dtgSapMenus.Rows)
                {
                    ...
                    {
                        MessageBox.Show("Verifique que los campos de las cantidades no esten vacios");
                        return;
                    }
                }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No hay una Racion Solicitada selecionada", "Nutricion", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }

            FormSolicitadasEditar form = new FormSolicitadasEditar(Convert.ToInt32(txtIdRacionSolicitada.Text), Convert.ToInt32(cmbUnidades.SelectedValue.ToString()), cmbUnidades.Text, dtpFechaSolicitada.Text);
            form.ShowDialog();
        ...
        private void btnVerCantidadesXSap_Click(object sender, EventArgs e)
        {
            ...
            FormCargaSolicitadasCantidadesSap form = new FormCargaSolicitadasCantidadesSap(Convert.ToInt32(txtIdRacionSolicitada.Text));
            form.ShowDialog();
        ...
        private void ActualizarUnidadesCantidades()
        {
            ...
            int idRacionSolicitada = Convert.ToInt32(this.txtIdRacionSolicitada.Text.ToString());
            ...
            foreach (DUnidad unidad in listaUnidades)
            {
                ...
                {
                    listaFiltroDetallesXUnidad = listaSolicitadasDetalles.Where(x => x.unidad_id == unidad.id_unidad && x.tipo_menu_id == tipoMenu.id_tipo_menu).ToList();
        ...
        private void GuardarEditarEncabezado_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var solicitada = new DRacionSolicitada
                {
                ...
                nRacionSolicitada.Editar(solicitada);
        ...
        private void btnEliminarRacionesCargadas_Click(object sender, EventArgs e)
        {
            ...
            DialogResult resultado = MessageBox.Show(
                "⚠️ Esta acción eliminará todos las raciones cargadas para esta solicitada.\n\n¿Desea continuar?",
        ...
        private void btnObservaciones_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txtIdRacionSolicitada.Text))
            {
                MessageBox.Show("Debe seleccionar una solicitada", "Nutricion", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }

            FormObservaciones formObservaciones = new FormObservaciones("observacion_solicitada", Convert.ToInt32(txtIdRacionSolicitada.Text));
